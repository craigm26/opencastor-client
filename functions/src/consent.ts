...
export const requestConsent = https.onCall({ cors: ["https://app.opencastor.com", "https://opencastor-client.pages.dev", "http://localhost"], invoker: "public" }, async (request) => {
...
export const resolveConsent = https.onCall({ cors: ["https://app.opencastor.com", "https://opencastor-client.pages.dev", "http://localhost"], invoker: "public" }, async (request) => {
  const auth = request.auth;
  if (!auth) throw new https.HttpsError("unauthenticated", "Must be authenticated");
...
export const revokeConsent = https.onCall({ cors: ["https://app.opencastor.com", "https://opencastor-client.pages.dev", "http://localhost"], invoker: "public" }, async (request) => {
  const auth = request.auth;
  if (!auth) throw new https.HttpsError("unauthenticated", "Must be authenticated");
